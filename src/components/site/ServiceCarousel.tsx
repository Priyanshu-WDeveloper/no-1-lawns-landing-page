...
import type { NewLawnService, NewLawnReview } from '@/types/new-lawns.types';
      ...
      <div className="overflow-hidden -ml-4" ref={emblaRef}>
        <div className="flex">
          {services.map((s) => (
            ...
            >
              <ServiceCard service={s} phone={phone} areas={areas} testimonial={testimonial} variant={variant || 'simple'} />
            </div>
          ))}
        </div>
      </div>
